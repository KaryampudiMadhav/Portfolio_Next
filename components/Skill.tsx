    ...
    <div className="group relative flex cursor-pointer">
      {skill?.image ? (
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 1 }}
          className="rounded-full border-2 border-darkGreen bg-gray-700 flex items-center justify-center w-16 h-16 md:w-20 md:h-20 lg:w-20 lg:h-20 xl:w-20 xl:h-20 2xl:w-28 2xl:h-28 filter group-hover:grayscale transition duration-300 ease-in-out"
        >
